...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-900 text-white font-sans selection:bg-yellow-500 selection:text-black">
      <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-neutral-950/90 backdrop-blur-md border-b border-white/10 py-4' : 'bg-transparent py-6'}`}>
        <div className="container mx-auto px-6 flex justify-between items-center">
          <div className="text-2xl font-black tracking-tighter uppercase italic">
            VAIDEHI<span className="text-yellow-500">CHAUDHARI</span>.
          </div>
      ...
      <section id="home" className="relative h-screen flex items-center pt-20 overflow-hidden">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-neutral-800/30 to-transparent skew-x-[-10deg] translate-x-1/4"></div>
        <div className="absolute bottom-0 left-0 w-full h-1/2 bg-gradient-to-t from-neutral-900 via-neutral-900/80 to-transparent z-10"></div>
          ...
          <div className="order-2 md:order-1 space-y-6">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              <a href="#media" className="border border-white/20 text-white px-8 py-4 font-bold uppercase tracking-wider hover:bg-white/10 transition-colors duration-300 flex items-center gap-2">
                <Play size={18} fill="currentColor" /> Watch Highlights
              </a>
            </div>
          </div>

          <div className="order-1 md:order-2 h-[50vh] md:h-full relative flex items-end justify-center">
            <div className="relative w-full max-w-lg aspect-[3/4] md:aspect-auto md:h-[85%] bg-neutral-800/50 rounded-lg overflow-hidden border border-white/5 flex items-center justify-center group">
              <img
                src="https://images.unsplash.com/photo-1599586120429-4828d5dabb04?q=80&w=2500&auto=format&fit=crop"
                alt="Vaidehi Chaudhari Action"
      ...
      <section id="media" className="py-24 bg-neutral-950">
        ...
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="md:col-span-2 md:row-span-2 group relative overflow-hidden h-[400px] md:h-[600px]">
            <img src="https://images.unsplash.com/photo-1612872087720-bb876e2e67d1?q=80&w=2000&auto=format&fit=crop" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="Match Point" />
          ...
          <div className="relative group overflow-hidden h-[300px] md:h-[292px]">
            <img src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=2000&auto=format&fit=crop" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="Serve" />
          </div>
          <div className="relative group overflow-hidden h-[300px] md:h-[292px]">
      ...
      <section id="contact" className="py-24 bg-neutral-900">
        <div className="container mx-auto px-6 max-w-4xl text-center">
          ...
          <div className="mt-20 pt-10 border-t border-white/10 flex justify-center space-x-8">
            <a href="https://instagram.com" target="_blank" rel="noreferrer" className="text-neutral-500 hover:text-white transform hover:scale-110 transition-all duration-300">
              <Instagram size={32} />
            </a>
            <a href="https://twitter.com" target="_blank" rel="noreferrer" className="text-neutral-500 hover:text-white transform hover:scale-110 transition-all duration-300">
              <Twitter size={32} />
            </a>
          </div>
